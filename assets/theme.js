      ...
      var CartSection = function () {
        ...
        _createClass(CartSection, [{
          ...
          value: function _attachListeners() {
            ...
            this.delegateElement.on('click', '.refreshcart', this._rerenderCart.bind(this));
          ...
          value: function _updateItemQuantity(event, target) {
            ...
            let isMulti = target.getAttribute('ismulti') && target.getAttribute('ismulti')?.length > 0;
            ...
            console.log('pricing level info old pricing level', pricingLevelOld)
            ...
            console.log('pricing level info new pricing level', pricingLevelNew)
            /// get boolean if we need to remove and update with new sku pricing level. 

            let shouldWeChangeSKU = shouldProductChangeSKU(pricingLevelNew, pricingLevelOld);
            ...
            console.log('pricing level info shouldWeChangeSKU', shouldWeChangeSKU)
            ...
            if (shouldWeChangeSKU && isMulti) {
              ...
              fetch(window.theme.localeRootUrl + '/cart/change.js', {
                body: JSON.stringify({ id: target.getAttribute('data-line-id'), quantity: 0 }),
                credentials: 'same-origin',
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json',
