...
function shouldProductChangeSKU(oldLevel, newLevel) {
  console.log("product level info old and new level", oldLevel, newLevel);
...
/******/ (function (modules) {
  ...
  /******/ [
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Dom__ =
              ...
              fastdom.measure(function () {
                var windowHeight = window.innerHeight,
                  activatorBoundingRect =
                    _this4.activator.getBoundingClientRect(),
          ...
          },
          {
            ...
            value: function _onOptionChanged(newValue, target, activator) {
              ...
              if (activator) {
                ...
                this["option" + target.getAttribute("data-option-position")] =
                  target.value;
                var selectedValue = "234";
                //target.closest('.ProductForm__Option').querySelector('.ProductForm__SelectedValue');
          ...
          },
          {
            ...
            value: function _initPhotoSwipeFromImageClick(event, target) {
              ...
              this._createPhotoSwipeInstance(
                this._createPhotoSwipeItemsFromImages(images),
                parseInt(
                  target.getAttribute("data-image-position-ignoring-video")
                )
              );
            },
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ProductReviews__ =
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ProductVariants__ =
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ScrollSpy__ =
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__SearchBar__ =
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ShippingEstimator__ =
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__VariantSelector__ =
        __webpack_require__(16);
      /* harmony reexport (binding) */ __webpack_require__.d(
        __webpack_exports__,
        "VariantSelector",
            ...
            value: function _openModal(modal) {
              ...
              fastdom.mutate(function () {
                ...
                _this15._onTransitionEndedListener =
                  _this15._onTransitionEnded.bind(_this15);
                ...
                if (
                  !_this15.activeModal.classList.contains("Modal--fullScreen")
                ) {
          ...
          },
          {
            ...
            value: function _closeModal() {
              ...
              fastdom.mutate(function () {
                ...
                if (
                  _this16.activeModal.classList.contains("Modal--videoContent")
                ) {
                  _this16._resetVideoListener =
                    _this16._resetVideo.bind(_this16);
                ...
                if (
                  !_this16.activeModal.classList.contains("Modal--fullScreen")
                ) {
                  ...
                  if (window.YT) {
                    _this28.player = new YT.Player(elementToInsert, {
                      ...
                      events: {
                        ...
                        onStateChange:
                          _this28._onYouTubeStateChange.bind(_this28),
                      },
                    });
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helper_Currency__ =
        __webpack_require__(4);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_ShippingEstimator__ =
        __webpack_require__(18);
        ...
        function CartSection(container) {
          ...
          if (this.options["hasShippingEstimator"]) {
            this.shippingEstimator =
              new __WEBPACK_IMPORTED_MODULE_3__components_ShippingEstimator__[
                "default"
        ...
        _createClass(CartSection, [
          ...
          },
          {
            ...
            value: function _attachListeners() {
              ...
              // document.addEventListener('product:added', this._rerenderCart.bind(this));
              document.addEventListener(
                "product:added",
                this._onProductAddedListener
              );
          ...
          },
          {
            ...
            value: function _updateItemQuantity(event, target) {
              console.log("updateItemQuantity", target);

              let oldQty = target.getAttribute("qty");
              let newQty = target.getAttribute("data-quantity");
              let upSku = target.getAttribute("upSku");
              let downSku = target.getAttribute("downSku");
              let isMulti =
                target.getAttribute("ismulti") &&
                target.getAttribute("ismulti")?.length > 0;
              console.log("upSku from js", upSku);
              console.log("downSku from js", downSku);
              /// get oldSku pricing level
              let pricingLevelOld = calculatePricingLevel(oldQty);

              console.log(
                "pricing level info old pricing level",
                pricingLevelOld
              );
              console.log("pricing level info old qty", oldQty);

              /// get new sku pricing level
              let pricingLevelNew = calculatePricingLevel(newQty);
              console.log("pricing level info new qty", newQty);
              console.log(
                "pricing level info new pricing level",
                pricingLevelNew
              );
              /// get boolean if we need to remove and update with new sku pricing level.

              let shouldWeChangeSKU = shouldProductChangeSKU(
                pricingLevelNew,
                pricingLevelOld
              );

              let changeIsIncrease = pricingLevelNew > pricingLevelOld;

              let newSku;

              if (shouldWeChangeSKU) {
                console.log("shouldWeChangeSKU", shouldWeChangeSKU);
                if (changeIsIncrease) {
                  newSku = upSku;
                } else {
                  newSku = downSku;
              ...
              console.log(
                "pricing level info shouldWeChangeSKU",
                shouldWeChangeSKU
              );
              console.log("pricing level info end -------------");
              /// if we need to remove, then remove and add newQty quantity with newsku

              /// If we do not need to remove, then we
              ...
              //// if do not need to change sku, then we run this. Else we
              if (shouldWeChangeSKU && isMulti) {
                console.log("shouldWeChangeSKU", shouldWeChangeSKU);
                ...
                console.log("quantity in else", quantity);
                fetch(window.theme.localeRootUrl + "/cart/change.js", {
                  body: JSON.stringify({
                    id: target.getAttribute("data-line-id"),
                    quantity: quantity,
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__helper_Currency__ =
        __webpack_require__(4);
              ...
              __WEBPACK_IMPORTED_MODULE_3__helper_Dom__["default"]
                ...
                .forEach(function (resetButton) {
                  resetButton.style.display =
                    _this37.currentTags.length === 0 ? "none" : "block";
                });
            },
          },
          {
            ...
            value: function _reloadProducts() {
              ...
              fetch(
                ...
                response.text().then(function (content) {
                  ...
                  _this38.collectionInnerElement.innerHTML =
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helper_Responsive__ =
        __webpack_require__(2);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components__ =
          ...
          },
          {
            ...
            value: function _closeNavigation() {
              ...
              fastdom.mutate(function () {
                __WEBPACK_IMPORTED_MODULE_0__helper_Dom__["default"]
                  .nodeListToArray(
                    _this46.element.querySelectorAll(".is-expanded")
                  )
                  .forEach(function (item) {
                    item.classList.remove("is-expanded");
                  });
          ...
          },
          {
            ...
            value: function _verifyNavigationOverlap() {
              ...
              fastdom.measure(function () {
                ...
                var mainTopMenu =
                  _this47.element.querySelector(".Header__MainNav");
                ...
                var instafeed = new Instafeed({
                  ...
                  success: function success(data) {
                    ...
                    data["data"].forEach(function (datum) {
                      datum["date"] = dateTimeFormatter.format(
                        new Date(parseInt(datum["created_time"]) * 1000)
                      );
                    });
                  },
                ...
                function (results, status) {
                  if (status !== google.maps.GeocoderStatus.OK) {
                    ...
                    var map = new google.maps.Map(
                        _this51.element.querySelector(".FeaturedMap__GMap"),
                        mapOptions
                      ),
                    ...
                    var styledMapType = new google.maps.StyledMapType(
                      JSON.parse(
                        _this51.element.querySelector("[data-gmap-style]")
                          .innerHTML
                      )
                    );
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Carousel__ =
        __webpack_require__(1);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ProductVariants__ =
        __webpack_require__(11);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ProductImageZoom__ =
        __webpack_require__(14);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_ProductReviews__ =
        __webpack_require__(15);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_ScrollSpy__ =
        __webpack_require__(17);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helper_Dom__ =
        __webpack_require__(0);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_OverflowScroller__ =
        __webpack_require__(13);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__helper_Responsive__ =
        __webpack_require__(2);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__helper__ =
        __webpack_require__(6);
      ...
      var ProductSection = (function () {
        function ProductSection(container) {
          ...
          if (this.options["templateSuffix"] !== "coming-soon") {
            this.productVariants =
              new __WEBPACK_IMPORTED_MODULE_1__components_ProductVariants__[
                "default"
              ](container, this.options);
          }

          this.productReviews =
            new __WEBPACK_IMPORTED_MODULE_3__components_ProductReviews__[
              "default"
            ](container);
          ...
          if (this.options["enableImageZoom"]) {
            this.imageZoomInstance =
              new __WEBPACK_IMPORTED_MODULE_2__components_ProductImageZoom__[
                "default"
              ...
              if (
                ...
                for (
                  ...
                  var cellElement =
                    ...
                    imageId = parseInt(
                      cellElement.getAttribute("data-image-id")
                    );

                  if (imageId === variant["featured_image"]["id"]) {
                    this.productSlideshow.selectCell(
                      parseInt(cellElement.getAttribute("data-image-position"))
                    );
                  }
                }
              } else {
                document
                  .querySelector(
                    '[href="#Image' + variant["featured_image"]["id"] + '"]'
                  )
                  .click();
            ...
            value: function _onScrollTargetChanged(event) {
              ...
              if (this.options["stackProductImages"]) {
                ...
                this.slideshowNavDotsItems[
                  parseInt(
                    event.detail.newTarget.getAttribute("data-image-position")
                  )
          ...
          },
          {
            ...
            value: function _switchToImage(event, target) {
              for (
                ...
                if (
                  imageId === parseInt(target.getAttribute("data-image-id"))
                ) {
                  this.productSlideshow.selectCell(
                    parseInt(cellElement.getAttribute("data-image-position"))
                  );
              ...
              fastdom.measure(function () {
                showAsideQuickNav =
                  ...
                  _this53.productAsideElement.offsetTop -
                    _this53.productAsideElement.clientHeight;
              });
              ...
              if (
                ...
                if (this.slideshowImages && this.slideshowImages.length > 1) {
                  ...
                  this.carouselNavScrollSpy =
                    new __WEBPACK_IMPORTED_MODULE_4__components_ScrollSpy__[
                      "default"
                ...
                this.calculateMinHeight = function calculateMinHeight() {
                ...
                if (window.ResizeObserver) {
                  this.productInfoResizeObserver = new ResizeObserver(
                    function () {
                      this.calculateMinHeight(); // We currently do not take advantage of the values returned by the observer as our calculation depends on other values
                    }
                  );
                ...
                this.productInfoScroller =
                  new __WEBPACK_IMPORTED_MODULE_6__components_OverflowScroller__[
                    "default"
                  ](this.productInfoElement);
          ...
          },
          {
            ...
            value: function _closePocketZoom() {
              ...
              fastdom.mutate(function () {
                ...
                _this63.outerCarousel.flickityInstance.viewport.style.transform =
                  null;
                ...
                .forEach(function (image) {
                  if (
                    ...
                    image.addEventListener(
                      "lazyloaded",
                      _this64._slideEnter.bind(_this64, slide)
                    );
                  } else {
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ImageWithTextBlockSection__ =
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__InstagramSection__ =
